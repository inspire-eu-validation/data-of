...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/of/4.0/OceanFeatures.xsd, using strict XML schema validation.<br>
