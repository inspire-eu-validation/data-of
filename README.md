...
The Data Specification on Oceanographic geographical features – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Oceanographic geographical features.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Oceanographic geographical features](http://inspire.ec.europa.eu/id/ats/data-of/3.0/of-gml) | INSPIRE spatial data set encoded in GML, Oceanographic geographical features features |
| [Application Schema, Oceanographic geographical features](http://inspire.ec.europa.eu/id/ats/data-of/3.0/of-as) | INSPIRE spatial data set |
| [Reference Systems, Oceanographic geographical features](http://inspire.ec.europa.eu/id/ats/data-of/3.0/of-rs) | INSPIRE spatial data set |
| [Data Consistency, Oceanographic geographical features](http://inspire.ec.europa.eu/id/ats/data-of/3.0/of-dc) | INSPIRE spatial data set |
| [Information Accessibility, Oceanographic geographical features](http://inspire.ec.europa.eu/id/ats/data-of/3.0/of-ia) | INSPIRE spatial data set |
| [Portrayal, Oceanographic geographical features](http://inspire.ec.europa.eu/id/ats/data-of/3.0/of-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Oceanographic geographical features - Core", are not needed as no feature instance can be of a type from that application schema.
...
Note that the TG conformance class is "informative" in the data specification. However, there is no such thing as an informative requirement. For a Technical Guidance, which the data specifications are, the TG requirements are normative and of should be the TG conformance classes.
